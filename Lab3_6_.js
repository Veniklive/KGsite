...
lib.ssMetadata = [
		{name:"Lab3_6__atlas_1", frames: [[0,0,1335,738]]}
];
...
(lib.Местопреступления = function() {
	this.initialize(ss["Lab3_6__atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#999999").ss(1,1,1).p("AHvAAIvdI8IAAx3g");
	this.shape.setTransform(11.15,-1.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("AzhrAMAnDAAAIAAWBMgnDAAAg");
	this.shape_1.setTransform(2,-2.45);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Anuo7IPdI7IvdI8g");
	this.shape_2.setTransform(11.15,-1.125);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#666666").s().p("AzhLBIAA2BMAnDAAAIAAWBgAmSJJIPdo8Ivdo7g");
	this.shape_3.setTransform(2,-2.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape},{t:this.shape_1}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-124,-73.9,252,143);
...
if (reversed == null) { reversed = false; }
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(1,1,1).p("ADYoZIFPAAIAARQIlPAAgAtkpmIbJAAIAATNI7JAAgAnWoZIFPAAIAARQIlPAAg");
	this.shape.setTransform(6.95,-0.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("AzhrAMAnDAAAIAAWBMgnDAAAg");
	this.shape_1.setTransform(12.85,1.05);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#CCCCCC").s().p("ACwIoIAAxPIFPAAIAARPgAn+IoIAAxPIFPAAIAARPg");
	this.shape_2.setTransform(10.95,0.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#666666").s().p("AzhLBIAA2BMAnDAAAIAAWBgAufJYIbIAAIAAzOI7IAAIbIAAIAATOI7IAAIAAzOIAATOgACdInIFPAAIAAxPIlPAAgAoRInIFPAAIAAxPIlPAAg");
	this.shape_3.setTransform(12.85,1.05);
...
p.nominalBounds = new cjs.Rectangle(-113.1,-70.4,252,143);
...
// stage content:
(lib.Lab3_6_ = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// btn
	this.btn_pause = new lib.pause();
	this.btn_pause.name = "btn_pause";
	this.btn_pause.setTransform(433.15,104.6);
	new cjs.ButtonHelper(this.btn_pause, 0, 1, 2, false, new lib.pause(), 3);

	this.btn_play = new lib.play();
	this.btn_play.name = "btn_play";
	this.btn_play.setTransform(158.45,108.1);
	new cjs.ButtonHelper(this.btn_play, 0, 1, 2, false, new lib.play(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.btn_play},{t:this.btn_pause}]}).wait(150));
...
// library properties:
lib.properties = {
	id: '81E0C2EAA5247B4C8F58CDF1CDA6E4D0',
	width: 1280,
	height: 720,
	fps: 30,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Lab3_6__atlas_1.png?1684943471761", id:"Lab3_6__atlas_1"},
		{src:"sounds/WeatherAmbienceWindBlizzardSnowWhistleGust.mp3?1684943471789", id:"WeatherAmbienceWindBlizzardSnowWhistleGust"}
	],
	preloads: []
};
...
an.compositions['81E0C2EAA5247B4C8F58CDF1CDA6E4D0'] = {
